# -*- coding: utf-8 -*-
# Download-Manager-Screen fuer MagentaMusik.
...
class MagentaMusikDownloadManagerScreen(Screen):
    if IS_FHD:
        skin = """
        <screen name="MagentaMusikDownloadManagerScreen" position="360,200" size="1200,730" flags="wfNoBorder">
            ...
            <widget name="progress_label" position="40,285" size="1120,44" font="Regular;30" halign="left"   foregroundColor="#00cc0066" transparent="1" />
            ...
            <widget name="hint_red"      position="56,660"  size="360,50"  font="Regular;32" halign="left" valign="center" foregroundColor="#CCCCCC" transparent="1" />
            <eLabel position="460,667" size="8,40" backgroundColor="#FFD700" zPosition="2" />
            <widget name="hint_yellow"   position="476,660" size="360,50"  font="Regular;32" halign="left" valign="center" foregroundColor="#CCCCCC" transparent="1" />
        ...
        skin = """
        <screen name="MagentaMusikDownloadManagerScreen" position="240,133" size="800,500" flags="wfNoBorder">
            ...
            <widget name="progress_label" position="27,190" size="746,30"  font="Regular;20" halign="left"   foregroundColor="#00cc0066" transparent="1" />
            ...
            <widget name="hint_red"      position="38,452"  size="240,33"  font="Regular;21" halign="left" valign="center" foregroundColor="#CCCCCC" transparent="1" />
            <eLabel position="307,455" size="5,27" backgroundColor="#FFD700" zPosition="2" />
            <widget name="hint_yellow"   position="318,452" size="240,33"  font="Regular;21" halign="left" valign="center" foregroundColor="#CCCCCC" transparent="1" />
